...
public class EventStoreQueueDataAdapterV2 : IEventStoreDataAdapter
{
    ...
    {
        return new EventStoreSequenceTokenV2("", cachedMessage.SequenceNumber, 0);
    }
    ...
    public virtual StreamPosition GetStreamPosition(EventRecord queueMessage)
    {
        ...
        var sequenceToken = new EventStoreSequenceTokenV2(queueMessage.Position.CommitPosition.ToString(), queueMessage.EventNumber.ToInt64(), 0);
